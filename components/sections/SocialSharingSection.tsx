    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        <Box sx={{ maxWidth: '900px', mx: 'auto', textAlign: 'center' }}>
          ...
          >
            Let’s impact the community together by Loving our Mothers and through worship! Share our event poster online and invite your friends for a memorable Evening of praise, community, and powerful encounters.
          </Typography>
